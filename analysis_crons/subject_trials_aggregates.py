...
# Main function
def create_subject_trials_agg(alyx_user, dry=False, only_new_subjects=False, logger=None):

    # Set up user, data formats, repos etc
    ...
    for i, sub in enumerate(subjects):
        try:
            ...
            # Otherwise, create aggregate dataset and save to disk
            all_trials = []
            for t in trials_ds:
                # load trials table
