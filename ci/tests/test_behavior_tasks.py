...
from ibllib.pipes.behavior_tasks import TrialsRegisterRaw, PassiveRegisterRaw
...
class TestTrialsRegisterRaw(base.IntegrationTest):
    ...
    def test_register(self):
        wf = TrialsRegisterRaw(self.session_path, task_collection='raw_behavior_data')
        status = wf.run()
...
class TestPassiveRegisterRaw(base.IntegrationTest):
    ...
    def test_register(self):
        wf = PassiveRegisterRaw(self.session_path, task_collection='raw_passive_data')
        status = wf.run()
