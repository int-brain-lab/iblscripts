...
class MotionBinDataset(PMDDataset):
    ...
    def __init__(self, dataset_path, ops_path):
        ...
        dataset_path : str, pathlib.Path
            The path to the raw binary data file (will be just /data.bin on the docker image).
	ops_path : str, pathlib.Path
	    The path to the ops.npy file containing parameters needed for PMD.
	    (will be just /ops.npy on the docker image).
        """
...
if __name__ == '__main__':
    ...
    print('Generating a comparison triptych')
