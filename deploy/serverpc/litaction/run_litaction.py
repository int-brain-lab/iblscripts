...
if __name__ == '__main__':
    ...
    parser.add_argument('pose_timestamp_file', help='timestamps associated with pose file')
    ...
    la_result = lightning_action(
        ...
        pose_timestamp_file=Path(args.pose_timestamp_file),
        wheel_file=Path(args.wheel_file),
        wheel_timestamp_file=Path(args.wheel_timestamp_file),
