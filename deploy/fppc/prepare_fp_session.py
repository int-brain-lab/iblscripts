...
def main(mouse):
    ...
    SESSION_FOLDER = DATA_FOLDER / SUBJECT_NAME / DATE / NUM / "raw_fp_data"
    SESSION_FOLDER.mkdir(parents=True, exist_ok=True)
    print(f"Created {SESSION_FOLDER}")


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Prepare fp PC for fibrephotometry recording session")
