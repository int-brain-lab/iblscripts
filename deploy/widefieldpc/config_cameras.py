...
try:
    ...
    raise ImportError("PYSPIN MODULE NOT FOUND IN ENV")
...
if __name__ == "__main__":
    ...
    parser.add_argument('-l', required=False, default=False,
                        action='store_true', help='List cameras')
    parser.add_argument('--enable_trig', required=False, default=False,
                        action='store_true',
                        help='Enable trigger mode for all cameras')
    parser.add_argument('--disable_trig', required=False, default=False,
                        action='store_true',
